  ...
  const messages = [
    {
      role: "system",
      content:
       "Eres asistente emocional y para crisis de ansiedad. Responde como un asistente experimentado, realiza recomendaciones para ayudar al usuario en su situación, recuerda todo lo que el usuario te ha dicho previamente de manera concisa. Habla en el idioma en el que el usuario te hable" + "No realices saludos automáticos, nunca"
    },
    ...recentMemory,
